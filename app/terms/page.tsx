  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white px-4 py-16">
      <div className="max-w-2xl mx-auto">
        <Link href="/" className="text-blue-400 text-sm hover:opacity-80 mb-8 block">← トップに戻る</Link>
        <h1 className="text-2xl font-bold mb-2">利用規約</h1>
        <p className="text-blue-400 text-sm mb-8">Terms of Service</p>
        <div className="space-y-8 text-sm text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-white font-bold mb-2">第1条（適用）</h2>
            <p>EC説明文生成AI（以下「本サービス」）の利用に関する条件を定めるものです。ユーザーは本規約に同意の上、本サービスをご利用ください。</p>
          </section>
          <section>
